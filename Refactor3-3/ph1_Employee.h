...
W tym przyk³adzie podklasy bêd¹ reprezentowa³y typy/stany pracowników, którzy zajmuj¹ odpowiednie
stanowiska w firmie. Ogólnie postrzegany pracownik bêdzie w okreslonym stanie i bêdzie mo¿liwa zmiana
tego stanu. Zastosujemy wzorzec STAN.
*/
